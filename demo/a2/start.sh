...
kubectl get po -l app=backend-service -o wide

echo creating ingress controller...
kubectl apply -f https://raw.githubusercontent.com/kubernetes/ingress-nginx/main/deploy/static/provider/kind/deploy.yaml

kubectl wait --namespace ingress-nginx --for=condition=ready pod --selector=app.kubernetes.io/component=controller --timeout=90s
kubectl --namespace ingress-nginx get po -l app.kubernetes.io/component=controller -o wide
...
kubectl wait --for=condition=ready ingress --selector=app=backend-ingress --timeout=180s
kubectl get po -l app=backend-ingress -o wide
